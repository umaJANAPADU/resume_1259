...
function education(e){
	...
	tb.border="2";
	var tr1="<tr><td>degree</td><td>institution</td><td>year of passing</td>";
	var tr2="";

	for(i=0;i<e.length;i++){
		tr2=tr2+"<tr><td>"+e[i].degree+"</td>0<td>"+e[i].institution+"</td><td>"+e[i].yearofpassind+"</td></tr>";
	}
...
function languages(l){
	var h2=document.createElement("h2");
	h2.textContent="language details";
	right.appendChild(h2);
	var hr=document.createElement("hr");
	right.appendChild(hr);
